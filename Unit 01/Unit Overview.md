...
-  Become familiar with the format and goals of the course ⭐️⭐️
- Develop the skill of using the UPI method to solve coding problems
- Access, iterate, and modify lists
- Perform advanced string manipulation and analysis

### Session 1: Course Structure | Strings & Arrays
...
### Session 2: UMPIRE | Strings & Arrays
