...
Given the head of the linked list `dna_strand` and two integers `m` and `n`, write a function `edit_dna_sequence()` that simulates the selective deletion of nucleotides in a DNA sequence. You will:
...
![Example 1 linked list before and after modification](https://courses.codepath.org/course_images/tip103/unit6_session2/controlled_burns_ex1.png) 
